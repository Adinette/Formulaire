<template>
  <div class="nam">
    <ul>
      <li><router-link to="/resultat"  class="butt" @click="resultat"> Consult my Registration</router-link></li>
      <li><router-link  to="/course" class="butt" @click="course"> Start my course</router-link></li>
    </ul>
    <div class="label">
      <div >
        <label>E-Mail : </label>
        <input type="email" class="input" id="email" v-model.trim="E_mail">
      </div>
      <div>
